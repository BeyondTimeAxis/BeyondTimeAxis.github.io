...
proceed = function(conditions, backwards){
	...
	//console.log("A:" + logscript_currentFrameID + ": click:" + player_status.proceed_click + ",timer:" + player_status.proceed_timer + ",typing:" + player_status.proceed_typing + ",click_met:" + player_status.proceed_click_met + ",timer_met:" + player_status.proceed_timer_met + ",typing_met:" + player_status.proceed_typing_met);
	...
	//console.log("B:" + logscript_currentFrameID + ": click:" + player_status.proceed_click + ",timer:" + player_status.proceed_timer + ",typing:" + player_status.proceed_typing + ",click_met:" + player_status.proceed_click_met + ",timer_met:" + player_status.proceed_timer_met + ",typing_met:" + player_status.proceed_typing_met);
	
	
	//console.log(logscript_currentFrameData);
	if (ls_clean_text_contents1 == ls_clean_text_contents2 || (logscript_lastMerged)){
		if ((!logscript_mergedFrame) && (logscript_currentFrameID != logscript_lastFrameID) && ((player_status.proceed_click_met) || (player_status.proceed_timer_met && player_status.proceed_timer && player_status.proceed_typing) || (player_status.proceed_typing_met) || ((!player_status.proceed_click_met) && (!player_status.proceed_timer_met) && (!player_status.proceed_typing_met))) && (logscript_currentText != "")){
			//if(conditions = 'timer'){}
			//alert(conditions + ":" + logscript_currentName + ": " + logscript_currentText);
			//console.log(logscript_currentFrameData);
